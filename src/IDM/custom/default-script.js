/**
 * @file This is a default script for just about anything
 * @version 0.1.0
 * @keywords default demo boilerplate template
 * @source cs_samples/samples/scripts/IDM/custom/default-script.js
 * @license
